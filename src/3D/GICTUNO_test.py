...
from src.NeuralOp.neural_operator import CTUNO1D, CTUNO2D, GICTUNO1D
...
if __name__ == "__main__":
    ...
    xT = sphere_data_generator_XT.generate_data(500, 1)
    print(xT.shape)
    ...
    x0 = sphere_data_generator_X0.generate_data(500, 5)
    print(x0.shape)
    ...
    model = GICTUNO1D(in_co_dim=3, out_co_dim=3, latent_geo_grid_sz=(10, 10, 10), latent_geo_grid_range_x=(-1, 1), latent_geo_grid_range_y=(-1, 1), latent_geo_grid_range_z=(-1, 1), gno_radius=0.5, gno_kernel_mlp_layers=[128, 128, 128,32], gno_transform_type="linear_kernelonly", lifting_dim=32, co_dims_fmults=(1, 2, 4), n_modes_per_layer=(16, 8, 4), norm="instance", act="gelu")
    ...
    checkpoint_path = project_root() + '/checkpoints/Gictuno_test'
    retrain_checkpoint_path = project_root() + '/checkpoints/Gictuno_test_retrain'
