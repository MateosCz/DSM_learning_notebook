...
class EulerMaruyama:
    ...
    @staticmethod
    def from_sde(sde, x0: jnp.ndarray, dt: float, total_time: float, batch_size: int, rng_key: jnp.ndarray) -> 'EulerMaruyama':
        return EulerMaruyama(sde.drift_fn(), sde.diffusion_fn(), x0, dt, total_time, batch_size, rng_key)
